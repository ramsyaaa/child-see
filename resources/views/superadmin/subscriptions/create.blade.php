        ...
        <div class="row align-items-center">
            ...
            <div class="col-md-12">
                <div class="page-header-title">
                    <h2 class="mb-0">Create Subscription</h2>
                </div>
            </div>
        </div>
    </div>
                ...
                <form action="{{ route('superadmin.subscriptions.store') }}" method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="date" class="form-control @error('end_date') is-invalid @enderror" id="end_date" name="end_date" value="{{ old('end_date', now()->addDays(30)->format('Y-m-d')) }}" required>
                            @error('end_date')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" class="form-control @error('quota_allocated') is-invalid @enderror" id="quota_allocated" name="quota_allocated" value="{{ old('quota_allocated') }}" min="1">
