                ...
                <form action="{{ route('superadmin.products.update', $product) }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select @error('type') is-invalid @enderror" id="type" name="type" required>
                            ...
                            <option value="dropin" {{ old('type', $product->type) == 'dropin' ? 'selected' : '' }}>Drop-in</option>
                            <option value="bundle" {{ old('type', $product->type) == 'bundle' ? 'selected' : '' }}>Bundle</option>
                        </select>
                        @error('type')
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" class="form-control @error('duration_days') is-invalid @enderror" id="duration_days" name="duration_days" value="{{ old('duration_days', $product->duration_days) }}" min="1">
                            @error('duration_days')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-select @error('quota_type') is-invalid @enderror" id="quota_type" name="quota_type">
                                <option value="unlimited" {{ old('quota_type', $product->quota ? 'limited' : 'unlimited') == 'unlimited' ? 'selected' : '' }}>Unlimited</option>
                                <option value="limited" {{ old('quota_type', $product->quota ? 'limited' : 'unlimited') == 'limited' ? 'selected' : '' }}>Limited</option>
                            </select>
                            @error('quota_type')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" class="form-control @error('quota') is-invalid @enderror" id="quota" name="quota" value="{{ old('quota', $product->quota) }}" min="1">
                            @error('quota')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
