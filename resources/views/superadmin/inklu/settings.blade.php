...
<div class="inklu-page-banner">
    <div>
        ...
        <p class="inklu-subtitle">Identitas, kontak, SEO, dan tampilan situs InkluSyncID</p>
    </div>
</div>
@endsection
                ...
                <div class="card-body">
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <input name="site_name" value="{{ $settings['site_name'] ?? 'InkluSyncID' }}" class="form-control" style="border-color:#BAA6D6;" required>
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-12">
                            ...
                            <small style="color:rgba(74,55,105,0.50);">Disarankan PNG transparan, min. 200px. Biarkan kosong untuk tidak mengubah.</small>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body">
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <input name="site_email" type="email" value="{{ $settings['site_email'] ?? '' }}" class="form-control" style="border-color:#BAA6D6;" placeholder="halo@inklusyncid.id">
                        </div>
                        <div class="col-md-6">
            ...
            <div class="card" style="border:1.5px solid rgba(186,166,214,0.25);">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <small style="color:rgba(74,55,105,0.50);">Disarankan 1200×630px</small>
                    </div>
                    ...
                    <div style="background:#fff;border:1px solid #dfe1e5;border-radius:8px;padding:1rem;margin-top:0.5rem;">
                        ...
                        <div style="font-size:0.7rem;color:#006621;margin:2px 0;">inklusyncid.id</div>
