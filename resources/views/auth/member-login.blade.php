...
<head>
    <title>Member Login - InkluSyncID</title>
    <meta charset="utf-8" />
            ...
            <div class="col-md-6">
                <div class="auth-card">
                    <div class="auth-header">
                        ...
                        <h2>Welcome Back!</h2>
                        <p class="mb-0">Continue your wellness journey</p>
                    </div>
                    <div class="auth-body">
                        ...
                        <div class="register-link">
                            <p class="mb-0">Don't have an account? <a href="{{ route('member.register') }}" style="color: var(--inklu-coral); font-weight: 500;">Register here</a></p>
                        </div>
                    </div>
                </div>
            </div>
